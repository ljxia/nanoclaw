...
export interface AllowedRoot {
  ...
  // If true, bypasses nonMainReadOnly for this root
  allowReadWriteNonMain?: boolean;
  // Optional description for documentation
  description?: string;
}

export interface ContainerConfig {
  gpus?: boolean; // Grant GPU access to the container (--gpus all)
...
export interface ImageAttachment {
  /** Path relative to the group folder, e.g. "media/1710000000-photo.jpg" */
  path: string;
...
export interface NewMessage {
  ...
  /** Image attachments saved to group media dir */
...
export interface Channel {
  ...
  // Optional: react to a message with an emoji (e.g. 👀 for acknowledgment).
